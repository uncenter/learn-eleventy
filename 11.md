...
Open up `eleventy-from-scratch/eleventy.config.js` and add the following before or after your work collection references:
...
You might have noticed we’re using the [spread syntax](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax).
...
>
> If you are using [Visual Studio Code](https://code.visualstudio.com/), you can use the keyboard shortcut [[icon:cmd]] + [[/]] to toggle native comments on and off in almost every supported language. Select a line or two in your editor and try it out!
