...
For the next 3 configurations, currently they do not have any callback methods to Eleventy's configuration API. So we'll need to implement them another way.
