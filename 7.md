...
{
	"name": "Issue 33",
	"url": "https://issue33.learneleventy.dev"
}
```

> [!TIP]
> The <https://issue33.learneleventy.dev> URL is the live site for the project you are building _right now_. You can change this to whatever the URL would be if you were going to also publish the site at the end of this course.
...
Now it’s time to _really_ push the boat out. You might have noticed that there’s a global call to action at the bottom of each page in the [demo site](https://issue33.learneleventy.dev). We can use global data to wire this up, too. So let’s do that.
