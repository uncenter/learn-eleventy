...
```njk
<meta name="description" content="A made up agency site that you build if you follow the Learn Eleventy course" />
```
...
You'll need to add a comma after `"url": "https://issue33.learneleventy.dev"` to stop your build from breaking.
...
![An RSS feed in the browser](/images/ss-rss.png)
