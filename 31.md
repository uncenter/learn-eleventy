...
We’ll start by copying through our default social image and favicon, then we’ll update our meta info partial. The first thing we need to do is add a passthrough copy.
