...
<a class="button" href="/static/eleventy-from-scratch-meta-images.zip">Download assets.</a>
...
What we’re doing here is saying to Netlify: "to deploy this site, run the build task from our `package.json` file and then publish the `dist` folder that you created."
