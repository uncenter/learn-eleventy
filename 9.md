...
First up, let’s take a look at the data we’re grabbing. In a new browser tab, go to <https://learn-eleventy.pages.dev/static/media.json>. You should see something that looks like this:
