...
If you are using VSCode, you can use the keyboard shortcut [[mac:cmd]] + [[/]] to toggle native comments on and off in almost every supported language. Try selecting a line (or multiple lines) and try it out!
