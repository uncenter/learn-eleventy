...
[Download the starter files.](/static/eleventy-from-scratch-starter-files.zip)

Once you have the starter files downloaded, unzip the folder and copy/paste or move the **entire contents** into your `eleventy-from-scratch` folder.
...
Dotfiles — (usually) hidden configuration files that start with a dot (.) — are pretty handy, so let’s add some.
...
>
> For every lesson, in the panel on the right side of the screen, there will be a link to a zip archive of a snapshot of the course project where it is at the end of the lesson that you’re on.
>
