...
Open up `eleventy-from-scratch/eleventy.config.js` and on **line 30**ish, before the closing `}` and below our other collections, create a new line and add the following:
