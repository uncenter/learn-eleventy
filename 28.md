...
Let’s add that to our critical CSS. Open up `eleventy-from-scratch/src/css/critical.scss` and on **line 94**, add the following, with the other utilities `@import` statements:
...
Let’s add that to our critical CSS. Open up `eleventy-from-scratch/src/css/critical.scss` and on **line 83**, add the following, with the other block `@import` statements:
...
Let’s add that to our critical CSS. Open up `eleventy-from-scratch/src/css/critical.scss` and on **line 84**, add the following, with the other block `@import` statements:
